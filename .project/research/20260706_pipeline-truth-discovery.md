...
| D3-7 | Attribute resolution map keyed by bare `owning_part_name` — same-named parts in different packages merge buckets, silent cross-wire that passes Step-8 validation | `graph_builder.py:984,1102` | Item 5 |
