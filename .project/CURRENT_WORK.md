...
**Last Updated**: 2026-08-14 (**phase-B cutover steps 4 and 5 EXECUTED** — step 5 `a4669af`
made live provenance portable and generated bytes route-equal, invariant 35 amended; step 6
(ruff R12 amendment) is next, then single-shot steps 7–8. Earlier the same day the
