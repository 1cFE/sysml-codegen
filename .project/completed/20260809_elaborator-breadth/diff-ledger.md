...
|---:|---|---|---|---|---|---|
| 1 | `agg_literal_probe` | error: `CodeGenerationError` | error: `CodeGenerationError` | — | expected-collapse | Equal non-executable control: neither route finds a calculation definition. |
