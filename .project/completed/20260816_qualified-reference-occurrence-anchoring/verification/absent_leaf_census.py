...
``none``
    No resolver-boundary call was observed before refusal. This includes load,
    extraction, and model-validation refusals, plus a run that raised before its first
    direct-reference call. Nothing about this root's population is known. The reason is
    recorded.
