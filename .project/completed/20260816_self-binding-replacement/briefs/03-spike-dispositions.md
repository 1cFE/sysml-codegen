...
## F-4 — the sideways reach → **owner-ruled removal vehicle filed**

The spike originally characterised this rather than calling it a defect: it was the only
occurrence, and a second converted it into a loud refusal. **Superseded 2026-08-16:** the owner
rejected fallbacks that accommodate behavior not explicitly supported by KerML/SysML v2 and
SysIDE. `[DEF-OWNED-SIDEWAYS-REACH]` now owns removal of the definition-owned lineage-miss
descendant search, the test flip from 7.0 to a named refusal, and the corresponding guidance update.
