...
Plan: `.project/active/qualified-reference-occurrence-anchoring/plan.md`, Phase 1, second checkbox.

Create `.project/active/qualified-reference-occurrence-anchoring/spike/deep-override-authorability/`
