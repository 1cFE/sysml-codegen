...
**Status:** Ratified target architecture — 2026-07-19. Implementation certification is separately
blocked on register rows 0 and 17.
**Owner:** Reid W
...
**Not established.** The adversarial review found the architecture coherent but the proof matrix
stub-satisfiable and several current-state claims unpinned. sysml-codegen is based at
`512786c7dfab44fba7a0185d09e845b7494c702d` with uncommitted lifecycle changes; agentic-mbse is
based at `4ed2a0728ea49298666415cd389d9a6173a81a3e` with uncommitted profile-v4 changes; TEAx's tracked
tree is at `d545701f575133350474108c96202a2ac5244462` with only untracked orchestration logs. These bases
are not a mutually installable candidate set. Certification of any candidate requires committed
hashes, locks, and one public-path artifact thread; ratification of the target architecture does not
wait on them.
...
- **LC-D09 [INHERITED]** Modeled defaults remain overridable typed contract parameters. They are not
  baked into predicate code and never become automatic study variables.
