...
Handwritten implementation required in handwritten/u3busagequalsingleocc/areacalculation_impl.py
"""
...
SysML Source: root-0/model.sysml:6
    ...
    IMPLEMENTATION: See spike_pkg.handwritten.u3busagequalsingleocc.areacalculation_impl
    ...
    def run(
        ...
        from spike_pkg.handwritten.u3busagequalsingleocc.areacalculation_impl import (
            run_areacalculation,
        )
