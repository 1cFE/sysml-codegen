...
from spike_pkg.modules.u3busagequalsingleocc.areacalculation import AreaCalculationModule

from spike_pkg.schemas.u3_b_usage_qual_single_occ_params import U3BUsageQualSingleOccParams as U3BUsageQualSingleOccParams
...
def create_spike_pkg_registry() -> PipelineModuleRegistry:
    ...
    return create_registry(
        ...
        module_type_override={            AreaCalculationModule: "u3busagequalsingleocc.AreaCalculationModule",        },
    )


# Custom schema types for TEAx pipeline registration
# Use with: execute_pipeline(..., custom_schema_types=CUSTOM_SCHEMA_TYPES)
CUSTOM_SCHEMA_TYPES = [    U3BUsageQualSingleOccParams,    Float,]
