...
from spike_pkg.modules.u2usagequaltwoownerocc.areacalculation import AreaCalculationModule

from spike_pkg.schemas.u2_usage_qual_two_owner_occ_params import U2UsageQualTwoOwnerOccParams as U2UsageQualTwoOwnerOccParams
...
def create_spike_pkg_registry() -> PipelineModuleRegistry:
    ...
    return create_registry(
        ...
        module_type_override={            AreaCalculationModule: "u2usagequaltwoownerocc.AreaCalculationModule",        },
    )


# Custom schema types for TEAx pipeline registration
# Use with: execute_pipeline(..., custom_schema_types=CUSTOM_SCHEMA_TYPES)
CUSTOM_SCHEMA_TYPES = [    U2UsageQualTwoOwnerOccParams,    Float,]
