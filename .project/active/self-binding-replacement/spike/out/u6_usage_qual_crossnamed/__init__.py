...
from spike_pkg.modules.u6usagequalcrossnamed.areacalculation import AreaCalculationModule

from spike_pkg.schemas.u6_usage_qual_crossnamed_params import U6UsageQualCrossnamedParams as U6UsageQualCrossnamedParams
...
def create_spike_pkg_registry() -> PipelineModuleRegistry:
    ...
    return create_registry(
        ...
        module_type_override={            AreaCalculationModule: "u6usagequalcrossnamed.AreaCalculationModule",        },
    )


# Custom schema types for TEAx pipeline registration
# Use with: execute_pipeline(..., custom_schema_types=CUSTOM_SCHEMA_TYPES)
CUSTOM_SCHEMA_TYPES = [    U6UsageQualCrossnamedParams,    Float,]
