...
### Case 18 — adjudicated → PRODUCT FINDING returned to Item 2 (cell OPEN)
...
- **Compose cases: 18/19 PASS** — 1, 2, 4, 5, 6, 7, 15, 25, 28, 29, 30, 31, 33, 34, 35, 36, 40, 41.
- **OPEN (1/19): case 18** → **Item 2** (product finding: `:>`-redefined constraint actual unresolved
  at generation; fix dispatched separately). The composed run otherwise complete.
...
**Row 17 certification status:** blocked ONLY by the single OPEN cell 18 (Item 2 product finding).
Everything else in the composed proof passes at the pinned set. No production code touched (N15
reverted); consumer repos at their pins (fusion-tea carries the committed test-infra migration
