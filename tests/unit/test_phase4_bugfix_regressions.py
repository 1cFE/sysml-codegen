...
def _bracketed_concrete(index: int) -> ConcreteConstraint:
    ...
    return ConcreteConstraint(
        ...
        predicate_source_key="inline:pkg::Cell::nonneg",
        is_negated=False,
        expected_value=True,
        ...
        inputs=[
            ConcreteConstraintInput(
                ...
                formal_identity=ConstraintFormalIdentity(raw_name="p"),
            ),
            ConcreteConstraintInput(
                formal_name="zero",
                resolution=ConstraintInputResolution.MODELED_DEFAULT,
                default_ir=None,
                formal_identity=ConstraintFormalIdentity(raw_name="zero"),
            ),
        ],
...
def test_constraint_only_design_attribute_gets_real_default_not_none():
    ...
    concrete = ConcreteConstraint(
        ...
        membership_kind="assert",
        predicate_source_key="inline:pkg::Demo::affordable",
        is_negated=False,
        expected_value=True,
