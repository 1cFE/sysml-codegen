...
the v5 capture script, which retired with the v5 family (retirement step 2), and it was
invisible to the Gate 4C part 3 surface check because a script import is not a package
import.
...
survived the v5 retirement by construction.
"""
